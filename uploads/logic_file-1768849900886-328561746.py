...
FIXED: Added comprehensive header detection for all sheets.
"""
...
def standardize(input_path, output_path):
    ...
    try:
        ...
        print("Critical Error reading Excel: " + str(e))
        return
    ...
    for sheet_name, df in xls_dict.items():
        ...
        if header_idx is None:
            print("Warning: Could not find header in sheet '" + sheet_name + "', skipping...")
            continue
        ...
        if items_count > 0:
            print("  ✓ " + sheet_name + ": " + str(items_count) + " items")
    ...
    print("Success. Converted " + str(len(df_out)) + " items.")
