...
Logic:
- Input: .xlsx file.
- Fetches real-time EUR->USD rate using standard 'urllib' (No 'requests' needed).
...
def get_eur_to_usd_rate():
    ...
    try:
        ...
        # (helps in some restricted environments, though use with caution)
...
def standardize(input_path: str, output_path: str):
    print("Starting KOSATEC conversion (Urllib Version)...")
    ...
    # Indices (0-based) based on your requirements
    # B=1, C=2, D=3, G=6, J=9
    idx_model = 1
    idx_name = 2
    idx_brand = 3
